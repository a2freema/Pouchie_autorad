...
Pouched rats had very dense binding in the VMH, with moderate binding in the BST, CeA and VTA. There was only a low level of binding in the OB and mPFC (Table 2, Figure 1).
...
![V1aR in the forebrain of the pouched rat. Image on left are Nissl stain, associated autoradiogram on right shows V1aR density. DG = Dentate Gyrus, CA3 = CA3 Region of the Hippocampus, BLA = Basolateral Amygdala, PH = Posterior Hypothalamus, VMH = Ventromedial Hypothalamic Nucleus.](Images/V1aR4.png)
...
fig2 <- fig2  +  scale_x_continuous(limits=c(-4.5, 4)) # because flipx is T, must reverse scale.
